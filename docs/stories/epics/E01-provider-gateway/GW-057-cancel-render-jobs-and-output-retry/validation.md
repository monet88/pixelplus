...
- GitNexus `detect_changes(scope=all)` reports only the expected Gateway application/contract-test scope, with low aggregate risk and no affected execution flows.
