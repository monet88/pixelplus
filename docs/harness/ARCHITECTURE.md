# Architecture — Reusable Harness Template

> This document is the generic Harness template content that previously lived at
> `docs/ARCHITECTURE.md`. It describes the reusable operating Harness and the
> consumer-application discovery guidance it ships with, not the PixelPlus
> system. For the PixelPlus Provider Gateway architecture, read
