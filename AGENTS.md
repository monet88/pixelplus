...
This project is indexed by GitNexus as **pixelplus** (7498 symbols, 27667 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
